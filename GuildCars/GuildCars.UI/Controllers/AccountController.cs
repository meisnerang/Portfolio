...
namespace GuildCars.UI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //get user & bar login if role is Disabled
            if (UserManager.FindByEmail(model.Email) != null)
            {
                ...
                if (role == "Disabled")
                {
                    ModelState.AddModelError("", "Your account has been disabled. Please contact your manager.");
                    return View(model);
                }
            }
        ...
        //Added ChangePassword from ManageController
        //GET
